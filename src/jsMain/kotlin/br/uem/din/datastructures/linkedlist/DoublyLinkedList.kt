...
/**
 * Implementação JS da Lista Duplamente Ligada com nós manuais `prev`/`next`.
 */
public actual fun <T> doublyLinkedListOf(): IndexedMutableLinkedList<T> = JsDoublyLinkedList()

private class JsDoublyLinkedList<T> : IndexedMutableLinkedList<T> {
