...
class DoublyLinkedListJsInteropTest {

    @Test
    fun testJsDoublyLinkedListRandomizedParityWithModel() {
        val random = Random(4042)
    ...
    @Test
    fun testJsDoublyLinkedListSupportsNullElements() {
        val list = doublyLinkedListOf<Int?>()
