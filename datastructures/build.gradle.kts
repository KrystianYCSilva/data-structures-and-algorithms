...
publishing {
    publications.withType<MavenPublication> {
        pom {
            name.set("algoritmos-otimizacao-datastructures")
            description.set("Estruturas de dados Kotlin Multiplatform: pilhas, filas, árvores, grafos, heaps, hash tables e mais.")
